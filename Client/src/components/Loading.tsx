...
const Loading = () => {
    return (
        <div className="px-6 min-h-screen bg-linear-to-br from-neutral-300 via-bg-lightGreen to-neutral-900 flex flex-col items-center justify-center relative overflow-hidden">
