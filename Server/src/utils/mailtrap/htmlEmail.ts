            ...
            <body>
              <div class="email-container">
                <div class="email-header">
                  <h1>Welcome to 🍴Dineflow 🍽️</h1>
                </div>
                <div class="email-body">
                  <p>Hi ${name},</p>
                  <p>Congratulations! Your email has been successfully verified.</p>
                  <p>We are excited to have you on board at Dineflow. Explore our platform and enjoy our services.</p>
                  <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                  <p>Best Regards,<br/>The Dineflow Team</p>
                </div>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The Dineflow Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2026 Dineflow. All rights reserved.</p>
            </div>
